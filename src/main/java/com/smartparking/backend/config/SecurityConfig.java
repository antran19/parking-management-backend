    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // ── Explicit public matchers (Swagger UI) ──
                        ...
                        // ── Security tra cứu xe ──
                        .requestMatchers("/api/v1/staff/sessions/active", "/api/v1/staff/sessions/history")
                        .hasAnyRole("STAFF", "MANAGER", "ADMIN", "SECURITY")
                        ...
                        .requestMatchers("/api/v1/security/exceptions", "/api/v1/security/exceptions/**")
                        .hasAnyRole("SECURITY", "STAFF", "MANAGER", "ADMIN")
